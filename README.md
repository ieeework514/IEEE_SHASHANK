...
AUTH_SECRET=your-random-secret # e.g. openssl rand -hex 32
# NEXTAUTH_URL=http://localhost:3000  # optional for local
```
...
4) Use the "Login" button → "Sign in with Google".
